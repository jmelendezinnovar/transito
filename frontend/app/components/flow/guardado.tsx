import { ArrowDownToLine, BrushCleaning, Database, FileSpreadsheet } from "lucide-react";
...
export default function GuardadoNode({ nombre, filas, tiempo }: ExcelNodeProps) {
    return (
